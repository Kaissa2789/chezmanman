...
{
name: "Le Bokit",
tagline: "Pain frit · poulet mariné · crudités",
desc: "Notre bokit signature — pâte frite dorée, poulet mariné à nos épices maison, salade fraîche et sauce chien maison.",
price: "8€",
img: dishBokit,
},
{
...
desc: "Brochettes grillées sur braises de bois, marinade maison aux épices créoles.",
price: "11€",
img: dishBrochettes,
},
{
...
desc: "Poulet cuit lentement au charbon de bois, servi avec riz ou frites et une salade fraîche.",
price: "12€",
img: dishGrill,
},
{
...
tagline: "Riz ou frites · salade",
desc: "Poisson mariné dans nos épices maison, accompagné de riz ou de frites et d'une salade fraîche.",
price: "14€",
img: dishPoisson,
},
{
...
desc: "Poulet mariné longuement dans nos épices maison, grillé au feu de charbon pour un goût authentique.",
price: "4,90€",
...
au charbon de bois, viande fraîche.
</p>
...
La viande arrive fraîche chaque matin. Préparation maison, cuisson sur
charbon de bois. Steve supervise chaque plat. Ici, rien ne sort
d'un congélateur.
</p>
</div>
<div className="bg-card/50 border border-border rounded-sm p-8">
...
<p className="text-foreground/70 text-sm leading-relaxed">
Les recettes viennent de là-bas. Transmises, pas inventées. Le charbon
de bois donne le goût authentique qu'aucun four ne peut reproduire.
</p>
</div>
<div className="bg-card/50 border border-border rounded-sm p-8">
<span className="inline-block font-display text-[10px] uppercase tracking-[0.2em] px-3 py-1 bg-[var(--gold)]/10 text-[var(--gold)] rounded-full mb-4">
